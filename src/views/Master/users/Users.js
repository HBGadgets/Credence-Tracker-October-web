          ...
          <div>
            ...
            >
              ...
              <Autocomplete
                ...
                id="groups-assigned"
                options={[
                  { _id: 'select_all', name: 'Select All Groups' },
                  { _id: 'new', name: 'Add New Group' },
                  ...groups,
                ]}
                ...
                onChange={(event, value) => {
                  const hasSelectAll = value.some((item) => item._id === 'select_all')
                  const hasNewGroup = value.some((item) => item._id === 'new')

                  let selectedValues = value.filter(
                    (item) => item._id !== 'select_all' && item._id !== 'new',
                  )
                  ...
                  handleInputChange({
                    target: {
                      name: 'groupsAssigned',
                      value: selectedValues.map((item) => item._id),
                    },
                  })
                ...
                renderOption={(props, option) => (
                  <Box
                    ...
                    sx={{
                      ...
                      alignItems: 'center',
                      fontStyle:
                        option._id === 'new' || option._id === 'select_all' ? 'italic' : 'normal',
                    }}
                  >
                    {option._id === 'new' && <IoMdAddCircle style={{ marginRight: 8 }} />}
                    {option._id === 'select_all' && (
                      <IoMdAddCircle style={{ marginRight: 8, transform: 'rotate(45deg)' }} />
                    )}
                    {option.name}
                  </Box>
                )}
